...
def test(args, IO, test_loader, output_dir):
    ...
    for batch_idx, data in enumerate(tqdm(test_loader, total=int(96*8*3 - 95*3), desc="Test_Loader")):
        ...
        if args.fold != 2:
            ...
            y_test1 = y2[0:7, :, :].squeeze(-1)   + Mean_Tensor[199:199+7, :]
            y_test2 = y2[14:21, :, :].squeeze(-1) + Mean_Tensor[199+14:199+21, :]
        ...
        if args.fold != 2:
            ...
            pred_all1 = pred_all[199+0:199+7, :]   + Mean_Tensor[199+0:199+7, :]
            pred_all2 = pred_all[199+14:199+21, :] + Mean_Tensor[199+14:199+21, :]
