...
class FeatMigrator(nn.Module):
    def __init__(self, args):
        ...
        self.fc_ = nn.Linear(2*self.hidden_dims+1, self.hidden_dims)
    ...
    def forward(self, Features, Patterns, mask):
        ...
        out = self.fc_(out)  # (199,96,hidden_dims)

        # 时间对齐
        out = self.Alignment(out.transpose(1,2))
        # print("FeatMigrator —— out:", out.shape)

        return out.transpose(1,2)  # (199,96,hidden_dims)