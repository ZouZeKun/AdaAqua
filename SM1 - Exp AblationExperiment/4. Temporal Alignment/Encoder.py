...
class FeatMigrator(nn.Module):
    def __init__(self, args):
        ...
        self.fc_out = nn.Linear(self.hidden_dims, 4*self.hidden_dims)
    ...
    def forward(self, Features, Patterns, mask):
        ...
        # 特征融合
        out = self.Transfer(out) # (199,96,hidden_dims)
        # print("FeatMigrator —— out:", out.shape)

        out = self.fc_out(out.transpose(1,2))  # (199,96,4*hidden_dims)
